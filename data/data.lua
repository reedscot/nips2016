...
function data.new(n, dataset_name, opt_)
  ...
  local donkey_file
  if dataset_name == 'mhp_keypoint_and_image' then
    donkey_file = 'donkey_folder_mhp_keypoint_and_image.lua'
  elseif dataset_name == 'mhp_keypoint_only' then
    donkey_file = 'donkey_folder_mhp_keypoint.lua'
  elseif dataset_name == 'cub_bbox_and_image' then
    donkey_file = 'donkey_folder_cub_bbox_and_image.lua'
  elseif dataset_name == 'cub_keypoint_and_image' then
    donkey_file = 'donkey_folder_cub_keypoint_and_image.lua'
  elseif dataset_name == 'cub_keypoint_only' then
    donkey_file = 'donkey_folder_cub_keypoint.lua'
  else
